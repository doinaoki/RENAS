...
def registerValue(repo, look):
    ...
    if look:
        ...
        dataPath = repo.joinpath("randomRanking", "figure", "figData.csv")
...
if __name__ == '__main__':
    ...
    if mainArgs.l:
        resultPath =  pathlib.Path(mainArgs.source[0]).parent.joinpath("visualRandomMerge")
    else:
